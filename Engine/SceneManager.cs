...
namespace Teamwork_OOP.Engine
{
	...
	public class SceneManager
	{
		...
		public SceneManager(TextureManager textureManager, DrawManager drawManager)
		{
			this.physicsEngine = new PhysicsEngine();

			this.MapManager = new MapManager(this.physicsEngine);
		...
		public void LoadTestLevel()
		{
			...
			this.TextureManager.AddTextureNode("mapBlock2", platformTextureNode);
