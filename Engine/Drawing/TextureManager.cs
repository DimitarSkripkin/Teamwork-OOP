...
namespace Teamwork_OOP.Engine.Drawing
{
	public class TextureManager
	{
		...
		public void Init(ContentManager contentMngr)
		{
			...
			//Texture2D blocksTexture = contentManager.Load<Texture2D>("TestTextures/mapTestBlocks");
		
			//blocksCoordinates = new List<Rectangle>();

			//Point startPoint = Point.Zero,
			//	size = new Point(32),
			//	stepX = new Point(32, 0);

			//blocksCoordinates.Add(new Rectangle(startPoint, size));
			//startPoint += stepX;
		...
		public void AddTextureNode(string nodeName, TextureNode textureNode)
		{
			this.textureNodes[nodeName] = textureNode;
		}
	}
}
